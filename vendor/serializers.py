...
class VendorSerializer(ModelSerializer):
    ...
    def update(self, instance, validated_data):
            ...
            self.multipledata(instance,vendor_address_data,vendor_addresses,VendorAddress)
    ...
    def multipledata(self,object,request_data,object_data,modelname):
        print('sdjfhjasdkhfkjsdhfkahk')
