...
class MaterialMasterCreate(APIView):
    ...
    def post(self, request, format='json'):
        ...
        if is_taxable=='true' and is_sales=='true':
            ...
            material_serializer = MaterialWithoutTaxSerializer(data=request.data)
...
#
#         if is_taxable == 'true' and is_sales == 'true':
#             material_master = Material.objects.filter(id=material)
#             for material_detail in material_master:
#                 print(material_detail.material_fullname)
#             material_serializer = MaterialSerializer(instance=material_master,data=request.data,partial=True)
#
#         else:
...
class MaterialMatserWithoutTax(ListCreateAPIView):
    queryset = Material.objects.all()
    serializer_class = MaterialWithoutTaxSerializer



class MaterialMatserUpdateWithoutTax(RetrieveUpdateDestroyAPIView):
    queryset = Material.objects.all()
    serializer_class = MaterialWithoutTaxSerializer
